...
<br>Я решил сделать свой аналог этих меовси фагов. 
...
<br>Касательно основы флагов можете почитать не оригинальной статье.
...
<br> `-XX:+TrustFinalNonStaticFields` - Флаг, который заставляет java оптимизировать не-static final поля так же как и static (т.е. константы), что позволяет значительно оптимизировать их работу.
